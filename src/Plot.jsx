...
// {
//   React app for uploading folders and parsing .out/.txt/.xls/.xlsx files.

// Builds a folder tree UI, lets you expand/collapse and select files.

// Reads file contents, extracts headers/units, and stores data rows.

// Allows selecting Y-axis columns against Time for plotting.

// Uses Plotly.js with downsampling to render interactive time-series plots.
// }
